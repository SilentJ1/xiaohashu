...
class CassandraTests {
    ...
    void testUpdate() {
        NoteContentDO nodeContent = NoteContentDO.builder()
                .id(UUID.fromString("0d51a208-87a5-4b88-be7b-092bd2ac3345"))
                .content("代码测试笔记内容更新")
                .build();
    ...
    @Test
    void testSelect() {
        Optional<NoteContentDO> optional = noteContentRepository.findById(UUID.fromString("0d51a208-87a5-4b88-be7b-092bd2ac3345"));
    ...
    @Test
    void testDelete() {
        noteContentRepository.deleteById(UUID.fromString("0d51a208-87a5-4b88-be7b-092bd2ac3345"));
    }
}
